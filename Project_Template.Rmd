...
Figure 6.2 is a map of North Carolina Power Plants including BIT plants and 5 other Primary Fuel Types
(WDS, SLW, BLQ, AB, DFO)
...
Figure 6.4 is an interactive map of all these maps side by side.
...
```{r scatter1, echo = FALSE, fig.cap = "PM 2.5 Data vs Number of Plants Plot"}
...
```{r scatter2, echo = FALSE, fig.cap = "PM 2.5 Data vs SVI Aggregate Plot"}
#Scatterplot 2
pm2.5_SVIaggregate <- 
