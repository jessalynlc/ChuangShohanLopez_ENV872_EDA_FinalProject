...
kable(PM2.5_summary, caption = 'PM 2.5 Data Summary')
kable(Retired_plants_summary, caption = 'Retired Plants Summary')
kable(NC_counties_summary, caption = 'North Carolina Counties Summary')
...
```{r powerplant.mapviewdata, fig.cap='Mapview of NC Coal-burning Power Plants', echo= FALSE}
...
Below is a map of North Carolina Power Plants including BIT plants and 5 other Primary Fuel Types
(WDS, SLW, BLQ, AB, DFO)
```{r powerplant.mapview2, fig.cap='Mapview of Top 6 PM Emitting Primary Fuel Power Plants in NC', echo=FALSE}
...
Below is a map of Operating vs. Retired North Carolina Power Plants.
...
```{r powerplants.operating.or.retired.map, fig.cap= 'Operating and Retired NC Plants', echo=FALSE}
...
```{r Linear.Regression.Corrplot, echo = FALSE}
